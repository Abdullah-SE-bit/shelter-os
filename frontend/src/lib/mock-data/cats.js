...
export const mockCats = [
  {
    id: 'cat-1', name: 'Luna', species: 'CAT', breed_label: 'Persian', gender: 'FEMALE', age_years: 2, age_months: 0,
    ...
    description: 'Luna is a gentle, affectionate Persian who loves quiet laps and sunny windowsills. She gets along well with other calm cats.',
    adoption_requirements: 'A quiet home with regular grooming for her long coat.',
  },
  {
    id: 'cat-2', name: 'Oliver', species: 'CAT', breed_label: 'Siamese', gender: 'MALE', age_years: 1, age_months: 3,
  ...
  {
    id: 'cat-3', name: 'Biscuit', species: 'DOG', breed_label: 'Golden Retriever', gender: 'MALE', age_years: 3, age_months: 0,
  ...
  {
    id: 'cat-4', name: 'Mochi', species: 'CAT', breed_label: 'Maine Coon', gender: 'FEMALE', age_years: 0, age_months: 8,
    ...
    adoption_requirements: 'A cat tree or vertical space is strongly recommended.',
  },
  {
    id: 'cat-5', name: 'Rex', species: 'DOG', breed_label: 'Labrador Retriever', gender: 'MALE', age_years: 4, age_months: 0,
  ...
  {
    id: 'cat-6', name: 'Whiskers', species: 'CAT', breed_label: 'Mixed Breed', gender: 'MALE', age_years: 5, age_months: 0,
  ...
  {
    id: 'cat-7', name: 'Buddy', species: 'DOG', breed_label: 'Beagle', gender: 'MALE', age_years: 2, age_months: 6,
  ...
  {
    id: 'cat-8', name: 'Coco', species: 'RABBIT', breed_label: 'Mixed Rabbit', gender: 'FEMALE', age_years: 1, age_months: 0,
...
export const getCatById = (id) => mockCats.find((c) => c.id === id) || null;

export const mockCatSpeciesLabel = { CAT: 'Cat', DOG: 'Dog', RABBIT: 'Rabbit' };
