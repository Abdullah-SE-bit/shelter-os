export const mockAdoptionListings = [
  { pet: 'pet-1', name: 'Luna', breed_label: 'Persian', gender: 'FEMALE', age_years: 2, age_months: 0, adoption_fee: 0, primary_photo_url: 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=600&q=80', shelter_name: 'Happy Paws Shelter', is_neutered: true, is_vaccinated_core: true, is_microchipped: true },
  { pet: 'pet-2', name: 'Oliver', breed_label: 'Siamese', gender: 'MALE', age_years: 1, age_months: 3, adoption_fee: 3500, primary_photo_url: 'https://images.unsplash.com/photo-1573865526739-10659fec78a5?w=600&q=80', shelter_name: 'Happy Paws Shelter', is_neutered: false, is_vaccinated_core: true, is_microchipped: true },
  { pet: 'pet-3', name: 'Biscuit', breed_label: 'Golden Retriever', gender: 'MALE', age_years: 3, age_months: 0, adoption_fee: 5000, primary_photo_url: 'https://images.unsplash.com/photo-1552053831-71594a27632d?w=600&q=80', shelter_name: 'Second Chance Animal Rescue', is_neutered: true, is_vaccinated_core: true, is_microchipped: true },
  { pet: 'pet-7', name: 'Buddy', breed_label: 'Beagle', gender: 'MALE', age_years: 2, age_months: 6, adoption_fee: 4500, primary_photo_url: 'https://images.unsplash.com/photo-1544568100-847a948585b9?w=600&q=80', shelter_name: 'Second Chance Animal Rescue', is_neutered: true, is_vaccinated_core: true, is_microchipped: true },
  { pet: 'pet-8', name: 'Coco', breed_label: 'Mixed Rabbit', gender: 'FEMALE', age_years: 1, age_months: 0, adoption_fee: 1500, primary_photo_url: 'https://images.unsplash.com/photo-1585110396000-c9ffd4e4b308?w=600&q=80', shelter_name: 'Happy Paws Shelter', is_neutered: true, is_vaccinated_core: false, is_microchipped: false },
];
