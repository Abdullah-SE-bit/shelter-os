export const mockRescueReports = [
  {
    id: 'rescue-1', description: 'Injured cat found near the market, limping on front leg.', urgency_level: 'HIGH', status: 'PENDING',
    reporter_name: 'Anonymous', reported_at: '2026-09-09T08:00:00Z', latitude: 33.7100, longitude: 73.0550,
    assigned_volunteer: null, assigned_volunteer_name: null, assigned_shelter_name: null, cat_condition_notes: 'Visible limp, otherwise alert and responsive.',
  },
  {
    ...
    assigned_volunteer: 'vol-2', assigned_volunteer_name: 'Priya Singh', assigned_shelter_name: 'Second Chance Animal Rescue', cat_condition_notes: 'Four kittens, approx. 3-4 weeks old, need bottle feeding.',
  },
  {
    ...
    assigned_volunteer: 'vol-1', assigned_volunteer_name: 'Casey Nguyen', assigned_shelter_name: 'Happy Paws Shelter',
    cat_condition_notes: 'Cold and shaken but uninjured.', resolved_at: '2026-08-20T15:00:00Z',
...
export const mockRescueSuggestions = {
  ranked_volunteers: [
    { volunteer_id: 'vol-1', name: 'Casey Nguyen', distance_km: 2.4, active_assignments: 1, available_now: true, score: 0.92 },
    { volunteer_id: 'vol-2', name: 'Priya Singh', distance_km: 6.1, active_assignments: 2, available_now: true, score: 0.71 },
    { volunteer_id: 'vol-3', name: 'Hamza Farooq', distance_km: 9.8, active_assignments: 0, available_now: false, score: 0.44 },
  ],
  nearest_shelters: [
