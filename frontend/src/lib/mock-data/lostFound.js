export const mockLostAlerts = [
  {
    id: 'lost-1', title: 'Lost orange tabby near Park Road', pet_name: 'Whiskers', status: 'ACTIVE', match_count: 1,
  ...
  {
    id: 'lost-2', title: 'Missing beagle, last seen near the park', pet_name: 'Duke', status: 'RESOLVED', match_count: 0,
...
export const mockFoundReports = [
  {
    id: 'found-1', description: 'Found a calm grey pet wandering near the bazaar, no collar.', status: 'OPEN', match_count: 1,
    ...
    photos: [], resolved_pet: null, shelter_name: null,
  },
  {
    ...
    photos: [], resolved_pet: 'pet-3', shelter_name: 'Second Chance Animal Rescue',
  },
];
...
export const mockMatches = [
  {
    ...
    lost_alert: { id: 'lost-1', title: 'Lost orange tabby near Park Road', pet_name: 'Whiskers', description: 'Orange tabby, medium size, white paws.', reporter_name: 'Bilal Ahmed', last_seen_at: '2026-09-07T18:00:00Z', reporter: 'u-8', photos: [] },
    found_report: { id: 'found-1', description: 'Found a calm grey pet wandering near the bazaar.', reporter_name: 'Zainab Ali', created_at: '2026-09-08T12:30:00Z', contact_phone: '+923091234567', photos: [] },
  },
];
