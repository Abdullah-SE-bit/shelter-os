...
import { mockMedications, byPet } from '@/lib/mock-data/medical';
...
export default function MedicationsPage() {
  ...
  const [medications, setMedications] = useState(() => byPet(mockMedications, petId));
  ...
  const handleSave = (e) => {
    ...
    setSaving(true);
    setTimeout(() => {
      setMedications((m) => [{ id: `med-${Date.now()}`, pet: petId, ...form }, ...m]);
      setAddOpen(false);
      setSaving(false);
    }, 350);
  };
