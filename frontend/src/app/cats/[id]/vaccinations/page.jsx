...
import { mockVaccinations, byCat } from '@/lib/mock-data/medical';
...
export default function VaccinationsPage() {
  ...
  const [vaccinations, setVaccinations] = useState(() => byCat(mockVaccinations, catId));
  ...
  const handleSave = (e) => {
    ...
    setSaving(true);
    setTimeout(() => {
      setVaccinations((v) => [{ id: `vac-${Date.now()}`, cat: catId, ...form }, ...v]);
      setAddOpen(false);
      setSaving(false);
    }, 350);
  };
