  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 py-6 sm:px-6">
      <PageHeader title="Adoption applications" description={`${total} total applications`}
        actions={<Button variant="secondary" size="sm" onClick={refetch} disabled={loading}><RefreshCw className="size-3.5" />Refresh</Button>} />
            ...
            <TableBody>
              {applications.map((app) => (
                <TableRow key={app.id}>
                  ...
                  <TableCell><Link to={`/cats/${app.cat}`} className="font-semibold text-primary">{app.cat_name}</Link></TableCell>
        ...
        {selected && (
          <div className="flex flex-col gap-4">
            <div className="flex gap-4 text-sm text-muted-foreground">
              <span>Cat: <strong className="text-foreground">{selected.cat_name}</strong></span>
