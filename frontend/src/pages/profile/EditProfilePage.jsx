      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-3.5">
            ...
            <div><Label>Bio</Label><Textarea value={form.bio} onChange={(e) => set('bio', e.target.value)} rows={3} placeholder="Tell us a bit about yourself and your love for cats…" className="mt-1.5" /></div>
          </CardContent>
        </Card>
        ...
        <div className="flex gap-3">
          <Button type="button" variant="secondary" className="h-11 flex-1" onClick={() => navigate('/profile')}>Cancel</Button>
