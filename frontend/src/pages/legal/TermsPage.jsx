...
import { PawPrint, ScrollText, ChevronLeft } from 'lucide-react';
      ...
      <div className="mx-auto max-w-[820px] px-6 pt-10 pb-16">
        ...
        <div className="rounded-2xl border border-border bg-card p-9 shadow-sm">
          <p className="mt-0 text-[15px] leading-relaxed text-muted-foreground">
            ...
            "Service"), a cat welfare, rescue, adoption and shelter-management system. By creating an account, signing
            in, or otherwise using the Service, you confirm that you have read, understood, and agree to be bound by
            these Terms and the Licensing Agreement below. If you do not agree, you may not use the Service.
          </p>
          ...
          <Section n="8" title="Licensing Agreement">
            <p className="mb-3">
              ...
              non-transferable, revocable license to access and use the Service for its intended cat-welfare
            ...
            <p className="mb-0">
              ...
              React, Django, and Django REST Framework. Map features use Leaflet and map data &copy; OpenStreetMap
              contributors, provided under the Open Database License (ODbL). Those components remain the property of
              their respective owners and are used in accordance with their licenses.
            </p>
          </Section>
